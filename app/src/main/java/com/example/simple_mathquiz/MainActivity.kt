...
class MainActivity : AppCompatActivity() {
    ...
    private fun generateRandomQuestion(): Question {
        ...
        val operator = random.nextInt(4) // 0 for addition, 1 for subtraction, 2 for multiplication, 3 for division

        val correctAnswer = when (operator) {
            0 -> num1 + num2 // addition
            1 -> num1 - num2 // subtraction
            2 -> num1 * num2 // multiplication
            3 -> num1 / (if (num2 != 0) num2 else 1) // division, avoiding division by zero
